          ...
          <v-card-text>
            ...
            <v-container fluid grid-list-md text-xs-center>
              ...
              >
                <EditDetail
                  title="template_name"
                  textContent="Which of unraids templates to use for the VM"
                  defaultValue="Windows+10"
                />
                <EditDetail
                  title="template_icon"
                  textContent="Unraid template icon"
                  defaultValue="windows.png"
                />
                <EditDetail
                  title="template_os"
                  textContent="Unraid template os"
                ...
                <EditDetail
                  title="media_cdrom"
                  textContent="The path to the install iso"
                />
                <EditDetail
                  title="media_cdrombus"
                  textContent="The bus for the install iso"
                  defaultValue="sata"
                />
                <EditDetail
                  title="media_drivers"
                  textContent="The path to the drivers iso"
                />
                <EditDetail
                  title="media_driversbus"
                  textContent="The bus for the drivers iso"
                  defaultValue="sata"
                />
                <EditDetail
                  title="domain_persistent"
                  textContent="Whether to persist vm"
                  defaultValue="1"
                />
                <EditDetail
                  title="domain_type"
                  textContent="VM type (not sure if unraid supports anything else?)"
                  defaultValue="kvm"
                />
                <EditDetail
                  title="domain_uuid"
                ...
                <EditDetail
                  title="domain_clock"
                  textContent="The time zone for the VM"
                  defaultValue="localtime"
                />
                <EditDetail
                  title="domain_arch"
                  textContent="The VM architecture"
                  defaultValue="x86_64"
                />
                <EditDetail
                ...
                <EditDetail
                  title="domain_name"
                  textContent="The name of the VM"
                />
                <EditDetail
                  title="domain_desc"
                  textContent="The VM description"
                />
                <EditDetail
                  title="domain_cpumode"
                  textContent="The CPU Mode"
                  defaultValue="host-passthrough"
                />
                <EditDetail
                  title="domain_vcpu"
                  textContent="An Array of threads to passthrough"
                  defaultValue="[0]"
                />
                <EditDetail
                  title="domain_mem"
                  textContent="Number of kilobytes of RAM to allocate this VM"
                />
                <EditDetail
                  title="domain_maxmem"
                  textContent="Maximum number of kilobytes of RAM to allocate this VM"
                />
                <EditDetail
                  title="domain_machine"
                  textContent="Machine type of VM (see Unraid GUI for options)"
                  defaultValue="pc-i440fx-3.1"
                />
                <EditDetail
                  title="domain_ovmf"
                  textContent="Bios type (OVMF (1) or SeaBios (0))"
                  defaultValue="1"
                />
                <EditDetail
                  title="domain_hyperv"
                  textContent="Whether to enable HyperV"
                  defaultValue="1"
                />
                <EditDetail
                  title="domain_usbmode"
                  textContent="USB Mode"
                  defaultValue="usb2"
                />
                <EditDetail
                  title="domain_password"
                  textContent="VNC password"
                />
                <v-flex>
                  <v-card>
                    <EditDetail
                      title="disks"
                      textContent="Array of disks, each an object containing:"
                    />
                    <EditDetail
                      title="image"
                      textContent="Path to disk image"
                    />
                    <EditDetail
                      title="select"
                    ...
                    <EditDetail
                      title="size"
                      textContent="Size of disk"
                      default-value="30G"
                    />
                    <EditDetail
                      title="driver"
                      textContent="Vdisk type (raw or qcow2)"
                    />
                    <EditDetail
                      title="bus"
                      textContent="Vdisk Bus"
                      default-value="sata"
                    />
                  </v-card>
                </v-flex>
                <v-flex>
                  <v-card>
                    <EditDetail
                      title="shares"
                      textContent="Array of sources, each an object containing:"
                    />
                    <EditDetail
                      title="source"
                      textContent="Path to source share"
                    />
                    <EditDetail
                      title="target"
                      textContent="Path to target folder"
                    />
                  </v-card>
                </v-flex>
                <v-flex>
                  <v-card>
                    <EditDetail
                      title="nics"
                      textContent="Array of network controllers, each an object containing:"
                    />
                    <EditDetail title="mac" textContent="Mac Address" />
                    <EditDetail
                      title="network"
                      textContent="Nic network"
                      default-value="br0"
                    />
                  </v-card>
                </v-flex>
